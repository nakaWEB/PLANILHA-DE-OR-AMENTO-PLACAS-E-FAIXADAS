...
// ======= VARIÁVEIS GLOBAIS =======
const nomesPaginas = [
    "CLIENTE", "BANNERS", "FAIXAS", "LONA COM ILHÓS",
...
function atualizarTotalGeral() {
    ...
    const AV30 = document.getElementById("AV30");
    const AV70 = document.getElementById("AV70");
    const AP30 = document.getElementById("AP30");
    const AP70 = document.getElementById("AP70");
    ...
    document.getElementById("AV30").textContent = "R$ " + (totalComImposto * 0.30).toFixed(2).replace('.', ',');
    document.getElementById("AV70").textContent = "R$ " + (totalComImposto * 0.70).toFixed(2).replace('.', ',');

    document.getElementById("AP30").textContent = "R$ " + ((totalComImposto * 0.05 + totalComImposto) * 0.30).toFixed(2).replace('.', ',');
    document.getElementById("AP70").textContent = "R$ " + ((totalComImposto * 0.05 + totalComImposto) * 0.70).toFixed(2).replace('.', ',');


    if (linha2) linha2.textContent = "R$ " + totalComImposto.toFixed(2).replace('.', ',');
    if (linha3) linha3.textContent = "R$ " + (totalComImposto * 0.05 + totalComImposto).toFixed(2).replace('.', ',');
    if (AV30) AV30.textContent = "R$ " + (totalComImposto * 0.30).toFixed(2).replace('.', ',');
    if (AV70) AV70.textContent = "R$ " + (totalComImposto * 0.70).toFixed(2).replace('.', ',');

    if (AP30) AP30.textContent = "R$ " + ((totalComImposto * 0.05 + totalComImposto) * 0.30).toFixed(2).replace('.', ',');
    if (AP70) AP70.textContent = "R$ " + ((totalComImposto * 0.05 + totalComImposto) * 0.70).toFixed(2).replace('.', ',');
}
